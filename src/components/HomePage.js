...
const HomePage = () => {
    ...
    useEffect(() => {
        //get vehicles:
        setVehicles([<Vehicle type={"Buick Century"} year={"2001"}/>, <Vehicle type={"Buick Century"} year={"2001"}/>, <Vehicle type={"Buick Century"} year={"2001"}/>]);
    }, []);
...
const Vehicle = ({type, year}) => {
    ...
    return (
        <div className='vehicle'>
            ...
            <p className='vehicle-type'>{type} | {year}</p>
