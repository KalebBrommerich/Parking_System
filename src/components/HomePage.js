    ...
    const  generateCars = async (token) => {
        ...
        try {
            ...
            generatedVehicles.data.forEach(vehicle => {
                vehicles.push(<Vehicle key={vehicle.permitNum} type={vehicle.make + " " + vehicle.model} liscensePlate={vehicle.plate}/>)
            });
...
const Vehicle = ({type, liscensePlate}) => {
    ...
    return (
        <div className='vehicle'>
            ...
            <p className='vehicle-type'>{type} | {liscensePlate}</p>
